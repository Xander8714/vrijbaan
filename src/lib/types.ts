...
// Eén vast speelmoment (bv. "elke dinsdag 20:00") voor de wekelijkse
// herinnering — tabel vaste_speelmomenten, zie src/app/account/VasteMomenten.tsx
// en scripts/poll-availability.ts. dag volgt JS Date#getDay() (0=zondag..
// 6=zaterdag). Een gebruiker kan er meerdere hebben (3 aug 2026: "zorg dat
// ik meer vaste momenten kan kiezen"), elk met een eigen aan/uit-vinkje.
export type VastSpeelmoment = {
  id: string;
  dag: number;
  tijd: string;
  gemeld: boolean;
